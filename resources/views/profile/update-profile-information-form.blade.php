...
//añadir los campos a la hora de actualizar los datos en la vista
        <div class="col-span-6 sm:col-span-4">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="twitter" type="text" class="mt-1 block w-full" wire:model.defer="state.twitter" autocomplete="twitter" />
